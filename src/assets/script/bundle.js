    ...
    (function(State) {
        ...
        class Blank extends Phaser.State {
            preload() {
                ...
                this.game.load.image('floor', '../land.png');
            }
            create() {
...
(function(Flappy) {
    ...
    (function(State) {
        ...
        class Play extends Phaser.State {
            preload() {
                this.game.load.spritesheet('bird', '../bird.png', 34, 24);
                this.game.load.spritesheet('birdColor', '../bird-color-layer.png', 34, 24);
                this.game.load.image('sky', '../sky.png');
                this.game.load.image('floor', '../land.png');
                this.game.load.image('pipeBody', '../pipe.png');
                this.game.load.image('pipeDownCap', '../pipe-down.png');
                this.game.load.image('pipeUpCap', '../pipe-up.png');
                this.game.load.image('splash', '../splash.png');
                this.game.load.image('gameOver', '../game-over.png');
                this.game.load.image('scoreBoard', '../score-board.png');
                this.game.load.image('replay', '../replay.png');
                this.game.load.image('bronzeMedal', '../medal-bronze.png');
                this.game.load.image('silverMedal', '../medal-silver.png');
                this.game.load.image('goldMedal', '../medal-gold.png');
                this.game.load.image('platMedal', '../medal-platinum.png');
                this.game.load.audio('wing', ['../sounds/sfx_wing.ogg', '../sounds/sfx_wing.mp3']);
                this.game.load.audio('hit', ['../sounds/sfx_hit.ogg', '../sounds/sfx_hit.mp3']);
                this.game.load.audio('die', ['../sounds/sfx_die.ogg', '../sounds/sfx_die.mp3']);
                this.game.load.audio('woosh', ['../sounds/sfx_swooshing.ogg', '../sounds/sfx_swooshing.mp3']);
                this.game.load.audio('point', ['../sounds/sfx_point.ogg', '../sounds/sfx_point.mp3']);
            }
            create() {
                this.scale.scaleMode = Phaser.ScaleManager.EXACT_FIT;
                this.game.stage.backgroundColor = '#4ec0ca';
